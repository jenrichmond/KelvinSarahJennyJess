...
# this function renames 185 phenomenological variables to make them compatible with pivot_longer()

rename_phenom <-function(data) {
  dplyr::rename(past_neutral_e1_text = past_neutral_6, 
